...
object F {
    ...
    const val autoSizeTextTypeUniformWithPresetSizes = "autoSizeTextTypeUniformWithPresetSizes"
    const val autoSizeTextType = "autoSizeTextType"
    const val breakStrategy = "breakStrategy"
    const val cursorVisible = "cursorVisible"
    ...
    const val hint = "hint"
    const val hyphenationFrequency = "hyphenationFrequency"
    const val imeOptions = "imeOptions"
    const val inputType = "inputType"
    const val justificationMode = "justificationMode"
    const val letterSpacing = "letterSpacing"
    const val lastBaselineToBottomHeight = "lastBaselineToBottomHeight"
    const val lineHeight = "lineHeight"
    const val lineSpacing = "lineSpacing"
    const val lines = "lines"
    const val linksClickable = "linksClickable"
    const val marqueeLimit = "marqueeLimit"
    const val maxEms = "maxEms"
    const val maxLines = "maxLines"
    const val minEms = "minEms"
    const val minLines = "minLines"
    const val scrollHorizontally = "scrollHorizontally"
    const val selectAllOnFocus = "selectAllOnFocus"
    const val singleLine = "singleLine"
    const val spans = "spans"
    const val items = "items"
    const val html = "html"
    const val text = "text"
    const val textContentType = "textContentType"
    const val textContent = "textContent"
    const val isAllCaps = "isAllCaps"
    ...
    const val cursorDrawable = "cursorDrawable"
    const val textIsSelectable = "textIsSelectable"
    const val textScaleX = "textScaleX"
    const val textSelectHandle = "textSelectHandle"
    const val textSelectHandleLeft = "textSelectHandleLeft"
    const val textSelectHandleRight = "textSelectHandleRight"
