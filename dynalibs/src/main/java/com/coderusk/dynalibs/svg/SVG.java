...
import com.coderusk.dynalibs.svg.utils.SVGBase;
...
public class SVG
{
    ...
    * @throws com.coderusk.dynalibs.svg.SVGParseException if there is an error parsing the document.
    */
   @SuppressWarnings("WeakerAccess")
   public static com.coderusk.dynalibs.svg.SVG getFromInputStream(InputStream is) throws com.coderusk.dynalibs.svg.SVGParseException
   {
      return new com.coderusk.dynalibs.svg.SVG(SVGBase.getFromInputStream(is));
   }
   ...
   public static com.coderusk.dynalibs.svg.SVG getFromString(String svg) throws com.coderusk.dynalibs.svg.SVGParseException
   {
      return new com.coderusk.dynalibs.svg.SVG(SVGBase.getFromString(svg));
   }
    ...
    */
   @SuppressWarnings("WeakerAccess")
   public static com.coderusk.dynalibs.svg.SVG getFromResource(Context context, int resourceId) throws com.coderusk.dynalibs.svg.SVGParseException
   {
    ...
    */
   @SuppressWarnings("WeakerAccess")
   public static com.coderusk.dynalibs.svg.SVG getFromResource(Resources resources, int resourceId) throws com.coderusk.dynalibs.svg.SVGParseException
   {
      return new com.coderusk.dynalibs.svg.SVG(SVGBase.getFromResource(resources, resourceId));
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public static com.coderusk.dynalibs.svg.SVG getFromAsset(AssetManager assetManager, String filename) throws com.coderusk.dynalibs.svg.SVGParseException, IOException
   {
      return new com.coderusk.dynalibs.svg.SVG(SVGBase.getFromAsset(assetManager, filename));
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public Picture renderToPicture(com.coderusk.dynalibs.svg.RenderOptions renderOptions)
   {
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public Picture renderToPicture(int widthInPixels, int heightInPixels, com.coderusk.dynalibs.svg.RenderOptions renderOptions)
   {
   ...
   {
      renderToCanvas(canvas, (com.coderusk.dynalibs.svg.RenderOptions) null);
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  renderToCanvas(Canvas canvas, com.coderusk.dynalibs.svg.RenderOptions renderOptions)
   {
   ...
   {
      renderToCanvas(canvas, com.coderusk.dynalibs.svg.RenderOptions.create().view(viewId));
   }
    ...
    * @throws com.coderusk.dynalibs.svg.SVGParseException if {@code value} cannot be parsed successfully.
    * @throws IllegalArgumentException if there is no current SVG document loaded.
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  setDocumentWidth(String value) throws com.coderusk.dynalibs.svg.SVGParseException
   {
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  setDocumentHeight(String value) throws com.coderusk.dynalibs.svg.SVGParseException
   {
    ...
    * documentation for {@link com.coderusk.dynalibs.svg.PreserveAspectRatio} for more information
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  setDocumentPreserveAspectRatio(com.coderusk.dynalibs.svg.PreserveAspectRatio preserveAspectRatio)
   {
    ...
    * element in the form of an {@link com.coderusk.dynalibs.svg.PreserveAspectRatio} object.
    * 
    * @return the preserveAspectRatio setting of the document's root {@code <svg>} element.
    * @throws IllegalArgumentException if there is no current SVG document loaded.
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public com.coderusk.dynalibs.svg.PreserveAspectRatio getDocumentPreserveAspectRatio()
   {
