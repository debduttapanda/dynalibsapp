...
package com.coderusk.dynalibs.svg.utils;
...
import com.coderusk.dynalibs.BuildConfig;
import com.coderusk.dynalibs.svg.SVGExternalFileResolver;
import com.coderusk.dynalibs.svg.utils.SVGBase.Box;
import com.coderusk.dynalibs.svg.utils.SVGBase.Circle;
import com.coderusk.dynalibs.svg.utils.SVGBase.ClipPath;
import com.coderusk.dynalibs.svg.utils.SVGBase.Colour;
import com.coderusk.dynalibs.svg.utils.SVGBase.CurrentColor;
import com.coderusk.dynalibs.svg.utils.SVGBase.Ellipse;
import com.coderusk.dynalibs.svg.utils.SVGBase.GradientElement;
import com.coderusk.dynalibs.svg.utils.SVGBase.GradientSpread;
import com.coderusk.dynalibs.svg.utils.SVGBase.GraphicsElement;
import com.coderusk.dynalibs.svg.utils.SVGBase.Group;
import com.coderusk.dynalibs.svg.utils.SVGBase.Image;
import com.coderusk.dynalibs.svg.utils.SVGBase.Length;
import com.coderusk.dynalibs.svg.utils.SVGBase.Line;
import com.coderusk.dynalibs.svg.utils.SVGBase.Marker;
import com.coderusk.dynalibs.svg.utils.SVGBase.Mask;
import com.coderusk.dynalibs.svg.utils.SVGBase.NotDirectlyRendered;
import com.coderusk.dynalibs.svg.utils.SVGBase.PaintReference;
import com.coderusk.dynalibs.svg.utils.SVGBase.PathDefinition;
import com.coderusk.dynalibs.svg.utils.SVGBase.PathInterface;
import com.coderusk.dynalibs.svg.utils.SVGBase.Pattern;
import com.coderusk.dynalibs.svg.utils.SVGBase.PolyLine;
import com.coderusk.dynalibs.svg.utils.SVGBase.Polygon;
import com.coderusk.dynalibs.svg.utils.SVGBase.Rect;
import com.coderusk.dynalibs.svg.utils.SVGBase.SolidColor;
import com.coderusk.dynalibs.svg.utils.SVGBase.Stop;
import com.coderusk.dynalibs.svg.utils.SVGBase.Svg;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgConditional;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgContainer;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgElement;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgElementBase;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgLinearGradient;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgObject;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgPaint;
import com.coderusk.dynalibs.svg.utils.SVGBase.SvgRadialGradient;
import com.coderusk.dynalibs.svg.utils.SVGBase.Switch;
import com.coderusk.dynalibs.svg.utils.SVGBase.Symbol;
import com.coderusk.dynalibs.svg.utils.SVGBase.TRef;
import com.coderusk.dynalibs.svg.utils.SVGBase.TSpan;
import com.coderusk.dynalibs.svg.utils.SVGBase.Text;
import com.coderusk.dynalibs.svg.utils.SVGBase.TextContainer;
import com.coderusk.dynalibs.svg.utils.SVGBase.TextPath;
import com.coderusk.dynalibs.svg.utils.SVGBase.TextSequence;
import com.coderusk.dynalibs.svg.utils.SVGBase.Unit;
import com.coderusk.dynalibs.svg.utils.SVGBase.Use;
import com.coderusk.dynalibs.svg.utils.SVGBase.View;
import com.coderusk.dynalibs.svg.utils.Style.CSSBlendMode;
import com.coderusk.dynalibs.svg.utils.Style.FontStyle;
import com.coderusk.dynalibs.svg.utils.Style.Isolation;
import com.coderusk.dynalibs.svg.utils.Style.RenderQuality;
import com.coderusk.dynalibs.svg.utils.Style.TextAnchor;
import com.coderusk.dynalibs.svg.utils.Style.TextDecoration;
import com.coderusk.dynalibs.svg.utils.Style.VectorEffect;
...
public class SVGAndroidRenderer
{
   ...
   void  renderDocument(SVGBase document, RenderOptionsBase renderOptions)
   {
      ...
      Box          viewBox;
      com.coderusk.dynalibs.svg.PreserveAspectRatio preserveAspectRatio;
   ...
   */
   ...
   private void render(Svg obj, Box viewPort, Box viewBox, com.coderusk.dynalibs.svg.PreserveAspectRatio positioning)
   {
      debug("Svg render");
      ...
      if (positioning == null)
         positioning = (obj.preserveAspectRatio != null) ? obj.preserveAspectRatio : com.coderusk.dynalibs.svg.PreserveAspectRatio.LETTERBOX;
   ...
   private void render(Symbol obj, Box viewPort)
   {
      ...
      // "If attribute 'preserveAspectRatio' is not specified, then the effect is as if a value of xMidYMid meet were specified."
      com.coderusk.dynalibs.svg.PreserveAspectRatio positioning = (obj.preserveAspectRatio != null) ? obj.preserveAspectRatio : com.coderusk.dynalibs.svg.PreserveAspectRatio.LETTERBOX;
    ...
    */
   private Matrix calculateViewBoxTransform(Box viewPort, Box viewBox, com.coderusk.dynalibs.svg.PreserveAspectRatio positioning)
   {
      Matrix m = new Matrix();
      ...
      if (positioning.equals(com.coderusk.dynalibs.svg.PreserveAspectRatio.STRETCH))
      {
      ...
      float  scale = (positioning.getScale() == com.coderusk.dynalibs.svg.PreserveAspectRatio.Scale.slice) ? Math.max(xScale,  yScale) : Math.min(xScale,  yScale);
   ...
   private void renderMarker(Marker marker, MarkerVector pos)
   {
      ...
      if (marker.viewBox != null)
      {
         ...
         com.coderusk.dynalibs.svg.PreserveAspectRatio positioning = (marker.preserveAspectRatio != null) ? marker.preserveAspectRatio :  com.coderusk.dynalibs.svg.PreserveAspectRatio.LETTERBOX;
         if (!positioning.equals(com.coderusk.dynalibs.svg.PreserveAspectRatio.STRETCH))
         {
            float  aspectScale = (positioning.getScale() == com.coderusk.dynalibs.svg.PreserveAspectRatio.Scale.slice) ? Math.max(xScale,  yScale) : Math.min(xScale,  yScale);
   ...
   private void  fillWithPattern(SvgElement obj, Path path, Pattern pattern)
   {
      ...
      // "If attribute 'preserveAspectRatio' is not specified, then the effect is as if a value of xMidYMid meet were specified."
      com.coderusk.dynalibs.svg.PreserveAspectRatio positioning = (pattern.preserveAspectRatio != null) ? pattern.preserveAspectRatio : com.coderusk.dynalibs.svg.PreserveAspectRatio.LETTERBOX;
