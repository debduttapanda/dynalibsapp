...
public class SVGImageView extends ImageView
{
   ...
   private final com.coderusk.dynalibs.svg.RenderOptions renderOptions = new com.coderusk.dynalibs.svg.RenderOptions();
   ...
   private class LoadResourceTask extends AsyncTask<Integer, Integer, SVG>
   {
      ...
      {
         com.coderusk.dynalibs.svg.SVGImageView.this.svg = svg;
         doRender();
      }
   }
